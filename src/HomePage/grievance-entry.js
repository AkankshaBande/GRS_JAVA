  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.values(errors).some((error) => error)) {
      Swal.fire({
        position: "center",
        icon: "error",
        title: "फॉर्ममध्ये त्रुटी आहेत, कृपया सर्व फील्ड्स तपासा.",
    ...
    try {
      ...
      Swal.fire({
        position: "center",
        icon: "success",
        title: "तक्रार यशस्वीरित्या सबमिट झाली",
        showConfirmButton: false,
        timer: 1500,
      });
      ...
      Swal.fire({
        position: "center",
        icon: "error",
        title: "तक्रार सबमिट करताना त्रुटी आली आहे.",
        showConfirmButton: false,
        timer: 1500,
      });
    }
